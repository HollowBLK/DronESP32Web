...
<body>
  ...
  <br><hr><br>
  <p><span id="textslider_values">%SLIDERVALUES%</span></p>
  <div id="motorInfo">%SLIDERTEXT%</div>
...
function updateSliderPWM(element, motorNumber) {
  ...
  xhr.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      // Actualiza el contenido del elemento con la información del motor
      document.getElementById("motorInfo").innerHTML = this.responseText;
    }
  };
...
String processor(const String& var){
  ...
  } else if (var == "SLIDERTEXT") {
    // Crear una cadena con la información de cada motor
    String motorInfo = "Motor 1: " + String(potValue1) + "<br>";
    motorInfo += "Motor 2: " + String(potValue2) + "<br>";
    motorInfo += "Motor 3: " + String(potValue3) + "<br>";
    motorInfo += "Motor 4: " + String(potValue4) + "<br>";
    return motorInfo;
  }
  return String();
}
